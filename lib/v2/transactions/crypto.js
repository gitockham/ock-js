...
function getBytes(transaction) {
	...
	bb.writeByte(transaction.network); // ock = 0x17, devnet = 0x30
...
function getKeys(secret, network) {
	var ecpair = ECPair.fromSeed(secret, network || networks.ock);
